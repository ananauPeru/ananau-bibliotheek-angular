  ...
  data: {
    ...
    AUTH: {
      GENERAL: {
        ...
        WELCOMETITLE2:
          "Una organización sin fines de lucro y no gubernamental para niños y jóvenes que viven en pobreza extrema y familias inestables.",
        OR: "O",
      ...
      FORGOT: {
        ...
        SUCCESS: "Su cuenta se ha restablecido correctamente.",
      },
      REGISTER: {
        TITLE: "Registrarse",
        DESC: "Ingrese sus datos para crear su cuenta",
        SUCCESS: "Su cuenta se ha registrado correctamente.",
        INCORRECT: "Los datos de registro son incorrectos",
    ...
    PROFILE: {
      PERSONAL_INFORMATION: {
        ...
        SUBTITLE: "Actualice su información personal",
      },
      INPUT: {
        AVATAR: "Avatar",
    ...
    LIBRARY: {
      ...
      CREATE: {
        BOOK: {
          ...
          CREATE_NEW_BOOK: "Crear Nuevo Libro",
          BACK: "Atrás",
          TITLE: {
            TITLE: "Título",
            F1: "Introduzca el Título del libro.",
            F2: "El título es obligatorio",
            F3: "El título debe tener al menos 3 símbolos",
            F4: "El título debe tener un máximo de 100 símbolos",
          },
          AUTHOR: {
            TITLE: "Autor",
            F1: "Por favor ingrese el Autor del libro.",
            F2: "Se requiere autor",
            F3: "El autor debe tener al menos 3 símbolos",
            F4: "El autor debe tener un máximo de 100 símbolos",
          },
          PURCHASED_AT: {
            TITLE: "Comprado En",
            F1: "Introduzca la fecha de compra del libro.",
            F2: "Se requiere la fecha de compra",
          },
          GENRE: {
            TITLE: "Género",
            D_DEFAULT: "Elija género",
            F1: "Seleccione un género.",
            F2: "Se requiere género.",
          },
          STATE: {
            TITLE: "Expresar",
            D_DEFAULT: "Seleccione estado",
            F1: "Seleccione el estado del libro.",
            F2: "Se requiere estado.",
          },
          PHOTO: {
            TITLE: "Sube una foto para este libro",
            MESSAGE:
              "Suelta tu imagen aquí o haz clic para seleccionar tu imagen.",
          },
          QUANTITY: {
            TITLE: "Cantidad",
            F1: "Introduzca una cantidad para el libro.",
            F2: "Se requiere cantidad.",
          },
          DESCRIPTION: {
            TITLE: "Descripción",
            PH: "Describe el artículo ...",
          },
        ...
        ITEM: {
          ...
          TITLE: {
            TITLE: "Título",
            F1: "Ingrese el título del artículo.",
            F2: "El título es obligatorio",
            F3: "El título debe tener al menos 3 símbolos",
            F4: "El título debe tener un máximo de 100 símbolos",
          },
          BRAND: {
            TITLE: "Marca",
            F1: "Ingrese la marca del artículo.",
            F2: "Se requiere marca",
            F3: "La marca debe tener al menos 3 símbolos",
            F4: "La marca debe tener un máximo de 100 símbolos",
          },
          PURCHASED_AT: {
            TITLE: "Comprado en",
            F1: "Ingrese la fecha de compra del artículo.",
            F2: "Se requiere la fecha de compra.",
          },
          PURPOSE: {
            TITLE: "Propósito",
            D_DEFAULT: "Seleccionar propósito",
            F1: "Seleccione un propósito.",
            F2: "Se requiere un propósito.",
          },
          COURSE: {
            TITLE: "Curso",
            D_DEFAULT: "Seleccionar curso",
            F1: "Seleccione el curso del artículo.",
            F2: "Se requiere curso.",
          },
          QUANTITY: {
            TITLE: "Cantidad",
            F1: "Ingrese la cantidad del artículo.",
            F2: "Se requiere cantidad.",
            F3: "La cantidad mínima debe ser 1.",
            F4: "La cantidad máxima debe ser 1000.",
          },
          CODE: {
            TITLE: "Código",
            F1: "Inserte un código para el artículo.",
            F2: "Se requiere el código.",
          },
          PIECES: {
            TITLE: "Piezas",
            F1: "Explique las piezas de una cantidad de un artículo.",
            F2: "Se requieren piezas",
            F3: "Las piezas deben tener al menos 3 símbolos",
            F4: "Las piezas deben tener un máximo de 100 símbolos.",
          },
          PHOTO: {
            TITLE: "Sube una foto para este artículo",
            MESSAGE:
              "Suelta tu imagen aquí o haz clic para seleccionar tu imagen.",
          },
          DESCRIPTION: {
      ...
      OVERVIEW: {
        BOOK: {
          TITLE: "Todos los libros de la biblioteca",
          ADD: "Agregar libro nuevo",
          GENRE: "Género",
          FILTER_PH: "Filtrar...",
        ...
        LOAN: {
          ...
          FILTER_PH: "Filtrar...",
          FILTER_SUB:
            "Intente buscar y filtrar por título del artículo / libro, nombre del usuario o correo electrónico del usuario.",
          NAME: "Nombre",
          LOANED_BY: "Prestado por",
      ...
      BOOK_OVERVIEW: {
        ANCIENT_EPIC: "Épica antigua",
        CHILDREN_GAMES: "Juegos para niños",
        DRAMATIC: "Dramático",
        DRAMATIC_THRILLER: "Dramático - Thriller",
        EPIC: "Épico",
        ESSAY: "Ensayo",
        FABLE: "Fábula",
        FABLES_COLLECTION: "Fábulas - Colección",
        MULTIPLICATIONS: "Multiplicaciones",
        NARRATIVE: "Narrativa",
        NOVEL: "Novela",
        NOVEL_CHILDREN: "Novela - Niños",
        NOVEL_FICTION: "Novela - Ficción",
        NOVEL_NARRATIVE: "Novela - Narrativa",
        NOVEL_NON_FICTION: "Novela - No ficción",
        NOVEL_PHILOSOPHICAL: "Novela - Filosófica",
        NOVEL_ROMANTIC: "Novela - Romántico",
        NOVEL_THRILLER: "Novela - Thriller",
        SHORT_STORIES: "Cuentos cortos",
        SUSPENSE: "Suspenso",
        TALE: "Cuento",
        TALES_COLLECTION: "Cuentos - Colección",
        TRAGEDY: "Tragedia",
      },
      ITEM_OVERVIEW: {
    ...
    EXERCISE: {
      CREATE: {
        ...
        TYPE_SELECT: "Seleccionar tipo de ejercicio",
        TYPE_REQUIRED: "Se requiere tipo de ejercicio.",
        MAX_GRAGE: "Calificación máxima",
        MAX_GRAGE_REQUIRED: "La calificación máxima debe ser al menos 1.",
        FILES: "Archivos",
      ...
      LIST: {
        ...
        CREATE_EXERCISE: "Crear ejercicio",
        SEARCH_TITLE_AUTHOR: "Buscar título o autor",
        TITLE: "Título",
        AUTHOR: "Autor",
        DESCRIPTION: "Descripción",
        TYPE: "Tipo",
      ...
      OVERVIEW: {
        ...
        GRADING_DATE: "Fecha de calificación",
        DETAILS: "Detalles",
        NO_SUBMISSIONS: "Aún no hay envíos",
        SUBMIT_EXERCISE: "Enviar ejercicio",
        DEADLINE_PASSED: "La fecha límite para este ejercicio ha pasado",
      },
      ASSIGN: {
        ...
        DEADLINE_REQUIRED: "Se requiere fecha límite",
        DEADLINE_FUTURE: "La fecha límite debe ser en el futuro",
        ASSIGN_TO: "Asignar a",
      ...
      SUBMISSION: {
        ...
        NO_FEEDBACK: "No se han proporcionado comentarios",
        FILES: "Archivos enviados",
        ...
        SUBMISSION_DATE_TABLE: "Fecha de envío",
