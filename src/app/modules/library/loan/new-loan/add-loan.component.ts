...
import { validators } from 'metronic/theme/html/demo1/src/plugins/formvalidation/src/js'
...
export class AddLoanComponent implements OnInit {
  ...
  saveForm() {
    ...
    if (this.loanedPiece.loaningUser) {
      ...
      console.log(this.loanedPiece.loaningUser)
    } else {
      console.log(this.loaningUser)
      console.log(this.loanedPiece)
    }
    ...
    console.log(formValues.loanDate)
